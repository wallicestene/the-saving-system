...
const Customers = ({customer}) => {
  ...
  return (
    <div className='customers flex flex-col gap-1  text-sm lg:text-base  bg-white rounded-md shadow-lg hover:bg-gradient-to-b from-gray-700 from-20% to-slate-400 hover:text-white'>
